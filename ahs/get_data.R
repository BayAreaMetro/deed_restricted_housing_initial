###Mostly, this is a modification of this script:
###https://github.com/ajdamico/asdfree/blob/master/American%20Housing%20Survey/download%20all%20microdata.R
###The author of that script is Anthony J Damico
###I've tried to keep his notes and comments
###The License on his script is GPL-3
###Any faults with the updated script are obviously my own

###At the top here I've copied and pasted a script that is relied upon to fetch HTML and Data
###written by http://hannes.muehleisen.org/

############
##Begin HTML/Download Script
############
...
############
##End HTML/Download Script
############


############
##Begin ACS Data Fetching Script
############
...
# contact anthony directly for free help or for paid consulting work
...
########
#There was a big chunk of HTML scraping here thats no longer relevant
#Probably because of a website redesign?
#The links to AHS files were scraped from this page:
#http://www.census.gov/programs-surveys/ahs/data.All.html"
#below we just hard-code the links with the years we need instead
########

y13c <- 'http://www2.census.gov/programs-surveys/ahs/2013/AHS%202013%20Metropolitan%20PUF%20v1.1%20CSV.zip'  
y11c <- 'http://www2.census.gov/programs-surveys/ahs/2011/AHS%202011%20National%20and%20Metropolitan%20PUF%20v1.4%20CSV.zip'  
precise.files <- c(y13c,y11c)



# this commented out section with more source data
# doesn't seem to fully work right now
# although, it might be necessary to get these other years in the future
# so leaving it in for now
# y82 <- 'http://www2.census.gov/programs-surveys/ahs/1982/AHS_1982_Metro_PUF_CSV.zip'
# y73 <- 'http://www2.census.gov/programs-surveys/ahs/1973/AHS_1973_National_PUF_CSV.zip'
# y09 <- 'http://www2.census.gov/programs-surveys/ahs/2009/AHS%202009%20National%20PUF%20V1.1%20Flat%20SAS.zip'
# y13c <- 'http://www2.census.gov/programs-surveys/ahs/2013/AHS%202013%20Metropolitan%20PUF%20v1.1%20CSV.zip'
# y11c <- 'http://www2.census.gov/programs-surveys/ahs/2011/AHS%202011%20National%20and%20Metropolitan%20PUF%20v1.4%20CSV.zip'
# y11s <- 'http://www2.census.gov/programs-surveys/ahs/2011/AHS%202011_National_and_Metropolitan_PUF_v1.4_Flat_SAS.zip'
# y09c <- 'http://www2.census.gov/programs-surveys/ahs/2009/AHS%202009%20National%20PUF%20v1.1%20CSV.zip'
# y09s <- 'http://www2.census.gov/programs-surveys/ahs/2009/AHS%202009%20National%20PUF%20V1.1%20Flat%20SAS.zip'
# precise.files <- c(y09,y13c,y11c,y11s,y09c,y09s)
